...
var (
	chromeVers  map[string]string
	firefoxVers map[string]string
	androidVers map[string]string
	safariVers  map[string]string
	operaVers   map[string]string
	ieVers      map[string]string
	edgeVers    map[string]string
